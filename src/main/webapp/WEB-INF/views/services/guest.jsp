...
<div id="wrapper" class="wrapper bg-ash">
  <jsp:include page="../wayupartyMasterHeader.jsp" />
                    	 ...
                    	 <form class="new-added-form" id="add_entry_service_form" name="add_entry_service_form" >
                    	 	<div class="row mt-2">	
                               ...
                               <div class="col-xl-3 col-lg-6 col-12 form-group">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group" id="divTimeRow">
                                    <label>Guest Entry Time<span class="text-danger">&nbsp;*</span></label>
                                    <div class='input-group bootstrap-timepicker'><input type='text' readonly='readonly' class='form-control' data-validation='required' field-name='Guest Entry Time' name='guestEntryTime' id='guestEntryTime'><span class='input-group-addon'>&nbsp;<i class='fa fa-clock' style='top: 15px;'></i></span></div>
                                </div>
     ...
     <script type="text/javascript">
		window.onload = function () {
			getGuestEntryCategories();
			var guestUUID = '${guestUUID}';
			if(guestUUID != null && guestUUID != '' && guestUUID != 'undefined'){
				getEntryDetails(guestUUID);
    ...
    <script>
	   function getEntryDetails(guestUUID){
	    	   var appUrl ='${appUrl}';
	    	   ...
	    	   $.ajax({
	    			  type: "GET",
	    			    url: appUrl+"/getVendorMasterServiceDetails?${_csrf.parameterName}=${_csrf.token}&serviceUUID="+guestUUID,
	    			     success :function(response) {
	    			    	 ...
	    			    	 $("#guestEntryTime").val(response.object.guestEntryTime);
  ...
  <script>
    function getGuestEntryCategories(){
    ...
    function validateVendorService(){
    	 ...
    	 if(startDate != null  && startDate != '' && startDate != 'undefined' && 
    		 ...
    		 formData.append("masterServiceUUID", guestUUID);
 ...
 function saveEntryService(){
	   if ($('#add_entry_service_form').validate(false, validationSettings)){
           ...
           formData.append("guestUUID",guestUUID);
